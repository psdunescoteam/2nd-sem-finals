...
const empowermentTechnologiesQuestions = [
  ...
  },
  {
    ...
    "correct": 0,
    "explanation": "This quote is attributed to Marshall McLuhan in the 'Media as Means' section of the reviewer."
  },
  {
    "id": 10,
...
const generalPhysicsQuestions = [
  {
    "id": 1,
    "question": "Who is the English Scientist who introduced the concept of electric field?",
    "options": [
    ...
    "correct": 2,
    "explanation": "Michael Faraday is the scientist credited with introducing the concept of the electric field to visualize non-contact forces."
  },
  {
    "id": 2,
    "question": "It is defined as the region around a charged object where another charge experiences an electric force.",
    "options": [
      "Electric Field",
      "Magnetic Field",
      "Gravitational Field",
    ...
    "correct": 0,
    "explanation": "An electric field is the region of space surrounding a charged particle or object within which a force would be exerted on other charged particles or objects."
  },
  {
    "id": 3,
    "question": "What is the standard unit used to express the amount of electric field?",
    "options": [
      "Newton (N)",
      "Coulomb (C)",
    ...
    "correct": 2,
    "explanation": "Electric field (E) is defined as force per unit charge (F/q), which results in the unit Newton per Coulomb (N/C)."
  },
  {
    "id": 4,
    "question": "What is the value of the Coulomb's constant (k)?",
    "options": [
      "$9.8 \\times 10^9 \\text{ N}\\cdot\\text{m}^2/\\text{C}^2$",
      "$8.99 \\times 10^9 \\text{ N}\\cdot\\text{m}^2/\\text{C}^2$",
      "$1.6 \\times 10^{-19} \\text{ N}\\cdot\\text{m}^2/\\text{C}^2$",
      "$6.67 \\times 10^{-11} \\text{ N}\\cdot\\text{m}^2/\\text{C}^2$"
    ],
    "correct": 1,
    "explanation": "The electrostatic constant (k) is approximately $8.99 \\times 10^9 \\text{ N}\\cdot\\text{m}^2/\\text{C}^2$ (often rounded to $9.0 \\times 10^9$ in calculations)."
  },
  {
    "id": 5,
    "question": "According to the principle of superposition, the net electric force on a charge is the _______ of the individual forces.",
    "options": [
      "Scalar sum",
      "Arithmetic average",
      "Vector sum",
    ...
    "correct": 2,
    "explanation": "The principle of superposition states that the total force is the vector sum of all individual forces acting on the charge."
  },
  {
    "id": 6,
    "question": "The electric field of a positive source charge is directed radially __________.",
    "options": [
      "Inward",
      "Outward",
      "Clockwise",
  ...
  {
    "id": 7,
    "question": "What happens to the electric force between two charges if the distance between them is doubled?",
    "options": [
      "It doubles.",
      "It triples.",
    ...
    "correct": 2,
    "explanation": "Based on Coulomb's Law (inverse square law), force is inversely proportional to the square of the distance ($1/r^2$). Doubling distance makes the force 1/4th."
  },
  {
    "id": 8,
    "question": "A small charged object used to determine the magnitude and direction of an electric field is called a __________.",
    "options": [
      "Source charge",
      "Test charge",
      "Point charge",
    ...
    "correct": 1,
    "explanation": "A test charge (usually positive) is used to map out the field produced by a source charge."
  },
  {
    "id": 9,
    "question": "In the conversion of units, what does the prefix 'µ' (micro) represent?",
    "options": [
      "$\\times 10^{-3}$",
      "$\\times 10^{-6}$",
      "$\\times 10^{-9}$",
    ...
    "correct": 1,
    "explanation": "Micro (µ) stands for $10^{-6}$."
  },
  {
    "id": 10,
    "question": "In the conversion of units, what does the prefix 'n' (nano) represent?",
    "options": [
      "$\\times 10^{-6}$",
      "$\\times 10^{-9}$",
      "$\\times 10^{-12}$",
    ...
    "correct": 1,
    "explanation": "Nano (n) stands for $10^{-9}$."
  },
  {
    "id": 11,
    "question": "The clustering or high density of electric field lines around a source charge suggests a __________ electric field.",
    "options": [
      "Weak",
      "Neutral",
      "Strong",
    ...
    "correct": 2,
    "explanation": "The density of field lines represents the strength of the field; the closer the lines, the stronger the field."
  },
  {
    "id": 12,
    "question": "Electric field is equal to the amount of _________ divided by the charge of an object.",
    "options": [
      "Work",
      "Energy",
      "Force",
    ...
    "correct": 2,
    "explanation": "The formula for electric field is $E = \\frac{F}{q}$."
  },
  {
    "id": 13,
    "question": "These are imaginary lines that represent the direction and strength of an electric field.",
    "options": [
    ...
    "correct": 0,
    "explanation": "Electric field lines are a visual tool used to represent the field's geometry."
  },
  {
    "id": 14,
    "question": "A function that is used to specify the spatial distribution of a physical quantity is called a ___________.",
    "options": [
      "Charge",
      "Field",
      "Scalar",
    ...
    "correct": 1,
    "explanation": "As defined in Lesson 4, a field describes how a physical quantity is distributed in space."
  },
  {
    "id": 15,
    "question": "What is the direction of the electric field for a negative source charge?",
    "options": [
      "Radially outward",
      "Radially inward",
    ...
    "correct": 1,
    "explanation": "Field lines are directed toward negative charges (radially inward)."
  },
  {
    "id": 16,
    "question": "Point charges are also known as __________.",
    "options": [
      "Test charges",
      "Source charges",
      "Neutral charges",
    ...
    "correct": 1,
    "explanation": "In the context of the PPT 'Quiz Number 2', point charges are referred to as source charges."
  },
  {
    "id": 17,
    "question": "If you have multiple charges, how do you find the net electric field at a specific point?",
    "options": [
      "Subtract the smallest field from the largest.",
      "Add the magnitudes without considering direction.",
      "Calculate the vector sum of the electric fields from each charge.",
      "Multiply all the fields together."
    ],
    "correct": 2,
    "explanation": "The principle of superposition applies to electric fields: $E_{\\text{net}} = E_1 + E_2 + \\dots$ (vector sum)."
  },
  {
    "id": 18,
    "question": "What is the prefix for 'p' (pico) in scientific notation?",
    "options": [
      "$\\times 10^{-9}$",
      "$\\times 10^{-12}$",
      "$\\times 10^{-15}$",
    ...
    "correct": 1,
    "explanation": "Pico (p) stands for $10^{-12}$."
  },
  {
    "id": 19,
    "question": "Coulomb's Law describes the force between two charges as being __________ proportional to the product of the charges.",
    "options": [
      "Inversely",
      "Directly",
      "Not",
    ...
    "correct": 1,
    "explanation": "$F = k\\frac{q_1 q_2}{r^2}$, so the force is directly proportional to the magnitude of the charges."
  },
  {
    "id": 20,
    "question": "The force between two charges is a __________ force because they do not need to touch to interact.",
    "options": [
      "Contact",
      "Non-contact",
      "Frictional",
    ...
    "correct": 1,
    "explanation": "Electrostatic forces, like gravity, act over a distance without physical contact."
  },
  {
    "id": 21,
    "question": "What is the unscrambled word for 'R F O C E' as used in the Lesson 2 pre-assessment?",
    "options": [
      "FORGE",
      "FORCE",
      "COREF",
    ...
    "correct": 1,
    "explanation": "Force is the unscrambled word."
  },
  {
    "id": 22,
    "question": "What is the unscrambled word for 'B O L M U O C'?",
    "options": [
      "COULOMB",
      "COLUMN",
      "COLOMBIA",
  ...
  {
    "id": 23,
    "question": "What is the unscrambled word for 'C E N T A S D I'?",
    "options": [
      "DECISTANT",
      "DISTANCE",
      "INSTANCED",
    ...
    "correct": 1,
    "explanation": "Distance is the 'r' in Coulomb's Law formula."
  },
  {
    "id": 24,
    "question": "What is the unscrambled word for 'T U D E G I N A M'?",
    "options": [
      "MAGNITUDE",
      "GUIDANCE",
      "MAGNIFY",
    ...
    "correct": 0,
    "explanation": "Magnitude refers to the size or amount of a physical quantity."
  },
  {
    "id": 25,
    "question": "Which of the following describes 'Electric Love' in the PPT context?",
    "options": [
    ...
    "correct": 1,
    "explanation": "The PPT title 'Electric Love vs Electric Hate' refers to attraction (opposite charges) and repulsion (like charges)."
  },
  {
    "id": 26,
    "question": "If two positive charges are placed near each other, they will __________.",
    "options": [
      "Attract",
      "Repel",
      "Cancel out",
  ...
  {
    "id": 27,
    "question": "If a positive and a negative charge are placed near each other, they will __________.",
    "options": [
      "Attract",
      "Repel",
      "Remain stationary",
  ...
  {
    "id": 28,
    "question": "Which variable represents charge in the formula $F = k\\frac{q_1 q_2}{r^2}$?",
    "options": [
      "F",
      "k",
      "q",
    ...
    "correct": 2,
    "explanation": "The letter 'q' represents the quantity of electric charge."
  },
  {
    "id": 29,
    "question": "In the formula $E = k\\frac{Q}{r^2}$, what does 'Q' represent?",
    "options": [
      "The test charge",
      "The source charge",
    ...
    "correct": 1,
    "explanation": "In electric field calculations for a point charge, Q is the charge producing the field (source charge)."
  },
  {
    "id": 30,
    "question": "What is the electrostatic force direction if $q_1$ is positive and $q_2$ is negative?",
    "options": [
    ...
    "correct": 1,
    "explanation": "Because they are opposite, the force is attractive, moving them toward each other."
  },
  {
    "id": 31,
    "question": "Superposition of forces is required when there are _________ charges in a system.",
    "options": [
      "Only two",
      "Three or more",
      "Zero",
    ...
    "correct": 1,
    "explanation": "Superposition is used to calculate the net force on one charge due to multiple other charges."
  },
  {
    "id": 32,
    "question": "The constant 'k' is also known as the __________ constant.",
    "options": [
      "Gravitational",
      "Planck's",
      "Electrostatic",
    ...
    "correct": 2,
    "explanation": "k is the electrostatic or Coulomb's constant."
  },
  {
    "id": 33,
    "question": "The direction of an electric field line at any point is the direction of the force on a __________ test charge.",
    "options": [
      "Positive",
      "Negative",
      "Neutral",
    ...
    "correct": 0,
    "explanation": "By convention, electric field direction is the direction of force on a positive test charge."
  },
  {
    "id": 34,
    "question": "When drawing field lines for two identical positive charges, the lines will __________.",
    "options": [
    ...
    "correct": 1,
    "explanation": "Because the fields repel, the lines bend away from the opposing charge and never cross."
  },
  {
    "id": 35,
    "question": "If the electric field is 10 N/C and the test charge is 2 C, what is the force?",
    "options": [
      "5 N",
      "12 N",
      "20 N",
    ...
    "correct": 2,
    "explanation": "$F = E \\cdot q$. So, $10 \\text{ N/C} \\times 2 \\text{ C} = 20 \\text{ N}$."
  },
  {
    "id": 36,
    "question": "Which scientists' names are associated with 'Coulomb's Law' and 'Electric Fields' in your PPTs?",
    "options": [
      "Coulomb and Faraday",
      "Newton and Einstein",
      "Tesla and Edison",
    ...
    "correct": 0,
    "explanation": "Charles-Augustin de Coulomb (Law) and Michael Faraday (Field concept) are the primary scientists mentioned."
  },
  {
    "id": 37,
    "question": "Electric field lines _________ cross each other.",
    "options": [
      "Always",
      "Sometimes",
      "Never",
    ...
    "correct": 2,
    "explanation": "Field lines represent a unique vector direction at every point; crossing would imply two directions at one point, which is impossible."
  },
  {
    "id": 38,
    "question": "The strength of the electric field _________ as you move further away from the source charge.",
    "options": [
      "Increases",
      "Decreases",
      "Stays constant",
    ...
    "correct": 1,
    "explanation": "E is inversely proportional to r². As distance increases, field strength decreases."
  },
  {
    "id": 39,
    "question": "A negative charge in an electric field will experience a force __________ the direction of the field lines.",
    "options": [
    ...
    "correct": 1,
    "explanation": "Field lines show the direction of force on a *positive* charge. A negative charge feels force in the opposite direction."
  },
  {
    "id": 40,
    "question": "In a system with multiple charges, the net electric field at the midpoint between two equal positive charges is __________.",
    "options": [
      "Double the individual fields",
      "Zero",
      "Infinite",
      "Four times the field"
    ],
    "correct": 1,
    "explanation": "The two field vectors point in opposite directions and cancel each other out at the exact midpoint."
  },
  {
    "id": 41,
    ...
    "correct": 1,
    "explanation": "The Coulomb (C) is the standard unit of charge."
  },
  {
    "id": 42,
    "question": "The principle that allows us to find the total effect of several charges by summing their individual effects is __________.",
    "options": [
      "The Power Rule",
    ...
    "correct": 1,
    "explanation": "Superposition is the core principle for handling multi-charge systems in both force and field calculations."
  },
  {
    "id": 43,
    "question": "Electric field lines start from _________ charges and end at _________ charges.",
    "options": [
      "Negative; Positive",
      "Positive; Negative",
      "Neutral; Positive",
    ...
    "correct": 1,
    "explanation": "Lines originate on positive charges and terminate on negative charges."
  },
  {
    "id": 44,
    "question": "A vector quantity has both __________ and __________.",
    "options": [
      "Speed; Time",
      "Magnitude; Direction",
      "Mass; Weight",
    ...
    "correct": 1,
    "explanation": "Electric force and electric field are vectors, requiring both magnitude and direction to be fully described."
  },
  {
    "id": 45,
    "question": "What is the magnitude of the charge of an electron?",
    "options": [
      "$9.11 \\times 10^{-31} \\text{ C}$",
      "$1.602 \\times 10^{-19} \\text{ C}$",
      "$8.99 \\times 10^9 \\text{ C}$",
      "$1.0 \\text{ C}$"
    ],
    "correct": 1,
    "explanation": "The elementary charge (magnitude of charge on electron or proton) is $1.602 \\times 10^{-19} \\text{ C}$."
  },
  {
    "id": 46,
    "question": "If you are asked to solve for '$F_{\\text{net}}$', you are looking for the __________.",
    "options": [
      "Total energy",
    ...
    "correct": 1,
    "explanation": "$F_{\\text{net}}$ stands for the net (total) force acting on a specific object."
  },
  {
    "id": 47,
    "question": "A 'test charge' is usually assumed to be _________ in magnitude.",
    "options": [
      "Very large",
      "Vanishingly small",
      "Negative",
    ...
    "correct": 1,
    "explanation": "A test charge must be small so that its own electric field does not significantly alter the field being measured."
  },
  {
    "id": 48,
    "question": "The force of attraction or repulsion between two stationary charges is known as __________ force.",
    "options": [
      "Magnetic",
      "Electrostatic",
      "Gravitational",
    ...
    "correct": 1,
    "explanation": "Electrostatic force (or Coulomb force) is the interaction between stationary charges."
  },
  {
    "id": 49,
    "question": "What happens to the electric field strength if the source charge (Q) is doubled?",
    "options": [
      "It remains the same.",
      "It is halved.",
      "It doubles.",
    ...
    "correct": 2,
    "explanation": "Since $E = k\\frac{Q}{r^2}$, the electric field is directly proportional to the source charge."
  },
  {
    "id": 50,
    "question": "Which of these prefix conversions is INCORRECT based on the Physics PPTs?",
    "options": [
      "$\\mu = 10^{-6}$",
      "$n = 10^{-9}$",
      "$p = 10^{-12}$",
...
const generalBiologyQuestions = [
  { "id": 1, "question": "What is the result of the union of a haploid egg cell (n) and a haploid sperm cell (n)?", "options": ["A zygote", "A diploid organism", "A homologous chromosome", "A genome"], "correct": 1, "explanation": "According to the inheritance of traits section, a sexually produced diploid (2n) organism is the result of the union of a haploid egg and sperm cell. [cite: 8, 416]" },
  { "id": 2, "question": "What is the normal diploid number of chromosomes in a human cell?", "options": ["23", "44", "46", "92"], "correct": 2, "explanation": "In humans, the normal diploid number of chromosomes is 46. [cite: 9, 416]" },
  { "id": 3, "question": "How many chromosomes are inherited from each parent in a normal human cell?", "options": ["46", "23", "12", "22"], "correct": 1, "explanation": "Half or 23 chromosomes are inherited from the father and the other 23 are contributed by the mother. [cite: 9, 416]" },
  { "id": 4, "question": "Which science studies how characteristics are inherited and how variations occur in offspring?", "options": ["Biology", "Genetics", "Cytology", "Evolution"], "correct": 1, "explanation": "The Science of Genetics studies how characteristics are inherited and how variations occur. [cite: 11, 416]" },
  { "id": 5, "question": "What are chromosomes primarily made of?", "options": ["RNA and proteins", "DNA molecules coiled around histones", "Pure protein fibers", "Lipid bilayers"], "correct": 1, "explanation": "A chromosome is made up of DNA molecules coiled around histones. [cite: 12, 416]" },
  { "id": 6, "question": "What term describes a specific sequence of DNA containing information codes for protein?", "options": ["Genome", "Allele", "Gene", "Nucleotide"], "correct": 2, "explanation": "A gene describes the specific sequence of DNA containing the information codes for protein. [cite: 14, 417]" },
  { "id": 7, "question": "What is the complete set of genes found in a cell responsible for the characteristics of an individual?", "options": ["Genotype", "Phenotype", "Genome", "Karyotype"], "correct": 2, "explanation": "Genome is the set of genes found in a cell responsible for the characteristics of an individual. [cite: 18, 417]" },
  { "id": 8, "question": "What refers to a pair of paternal and maternal chromosomes that are the same size with similar gene locations?", "options": ["Heterozygous chromosomes", "Homologous chromosomes", "Diploid pairs", "Sister chromatids"], "correct": 1, "explanation": "Homologous chromosomes refer to a pair of paternal and maternal chromosomes of the same size with similar gene locations. [cite: 21, 418]" },
  { "id": 9, "question": "What is the specific location of a gene on a chromosome called?", "options": ["Locus", "Allele", "Centromere", "Banding"], "correct": 0, "explanation": "Similar gene locations are also called loci (singular: locus). [cite: 21, 419]" },
  { "id": 10, "question": "What are the alternative forms of a gene called?", "options": ["Genotypes", "Phenotypes", "Alleles", "Histones"], "correct": 2, "explanation": "Alleles are one of two or more alternative forms of a gene. [cite: 23, 419]" },
  { "id": 11, "question": "Which term refers to the totality of the genetic makeup of an individual, often represented by symbols?", "options": ["Phenotype", "Genome", "Genotype", "Allele"], "correct": 2, "explanation": "Genotype is the totality of the genetic makeup of an individual and is represented by symbols. [cite: 28, 419]" },
  { "id": 12, "question": "What term refers to the observable expression or physical makeup of a particular genotype?", "options": ["Genotype", "Phenotype", "Locus", "Homozygous"], "correct": 1, "explanation": "Phenotype refers to the observable expression of a particular genotype or the physical makeup. [cite: 29, 419]" },
  { "id": 13, "question": "What is the condition when two similar alleles are present in a pair (e.g., BB or bb)?", "options": ["Heterozygous", "Dominant", "Homozygous", "Recessive"], "correct": 2, "explanation": "Homozygous is when two similar alleles are present in a pair. [cite: 30, 419]" },
  { "id": 14, "question": "What is the condition when two different alleles are paired (e.g., Bb)?", "options": ["Homozygous", "Heterozygous", "Monohybrid", "Dihybrid"], "correct": 1, "explanation": "Heterozygous is when two different alleles are paired. [cite: 31, 419]" },
  { "id": 15, "question": "Which allele is expressed in a heterozygous condition?", "options": ["Recessive allele", "Dominant allele", "Lethal allele", "Codominant allele"], "correct": 1, "explanation": "The dominant allele is the one expressed in a heterozygous condition. [cite: 32, 419]" },
  { "id": 16, "question": "Who is widely considered the pioneer and father of Genetics?", "options": ["Francis Crick", "James Watson", "Gregor Johann Mendel", "Shinobu Ishihara"], "correct": 2, "explanation": "Gregor Johann Mendel is the father of Genetics. [cite: 34, 420]" },
  { "id": 17, "question": "What is the scientific name of the garden pea plant used by Mendel in his experiments?", "options": ["Mirabilis jalapa", "Pisum sativum", "Ipomoea batatas", "Rosa indica"], "correct": 1, "explanation": "Mendel used the garden pea plant (Pisum sativum) to test his observations. [cite: 36, 420]" },
  { "id": 18, "question": "What type of cross involves a single trait or one-trait inheritance?", "options": ["Dihybrid cross", "Polygenic cross", "Monohybrid cross", "Test cross"], "correct": 2, "explanation": "A monohybrid cross is a cross involving a single trait or one-trait inheritance. [cite: 36, 420]" },
  { "id": 19, "question": "Which law states that paired unit factors segregate randomly so each gamete receives one or the other with equal likelihood?", "options": ["Law of Independent Assortment", "Principle of Dominance", "Law of Segregation", "Law of Unit Factors"], "correct": 2, "explanation": "The Law of Segregation states that during gamete formation, paired unit factors segregate randomly. [cite: 37, 48]" },
  { "id": 20, "question": "According to the Mendelian Principles, what happens when two unlike factors for a single trait are present?", "options": ["They blend together", "One masks the expression of the other", "They both disappear", "They both express equally"], "correct": 1, "explanation": "The Principle of Dominance and Recessiveness states that one factor in a pair may mask the expression of the other. [cite: 47, 48]" },
  { "id": 21, "question": "In genetics, what does 'F1' stand for?", "options": ["First Final Generation", "First Filial Generation", "Frequency of 1", "Factor 1"], "correct": 1, "explanation": "F1 (First Filial Generation) is the product of the Parental Generation. [cite: 39]" },
  { "id": 22, "question": "A cross involving two traits is known as a:", "options": ["Monohybrid cross", "Dihybrid cross", "Diploid cross", "Dual cross"], "correct": 1, "explanation": "A dihybrid cross is a cross involving two traits. [cite: 50]" },
  { "id": 23, "question": "Which law states that the inheritance of one trait is not affected by the inheritance of another trait?", "options": ["Law of Segregation", "Law of Independent Assortment", "Principle of Dominance", "Unit Factors in Pairs"], "correct": 1, "explanation": "The Law of Independent Assortment states the inheritance of one trait is not affected by another. [cite: 51, 52]" },
  { "id": 24, "question": "In a monohybrid cross of two heterozygous tall plants (Tt), what is the probability of having a short offspring (tt)?", "options": ["0%", "25%", "50%", "75%"], "correct": 1, "explanation": "In a cross of Rr x Rr (or similar heterozygous), the homozygous recessive (short) appears in 1/4 or 25% of the offspring. [cite: 44, 45]" },
  { "id": 25, "question": "What pattern of inheritance occurs when both dominant alleles are expressed, and the third phenotype is not a blend?", "options": ["Incomplete Dominance", "Codominance", "Polygenic Inheritance", "Sex-linked Inheritance"], "correct": 1, "explanation": "Codominance is when two dominant alleles are present and both are expressed; the third phenotype is not a blend. [cite: 61, 63]" },
  { "id": 26, "question": "The inheritance of the MN blood antigen in humans is an example of what pattern?", "options": ["Incomplete Dominance", "Lethal Genes", "Codominance", "Multiple Alleles"], "correct": 2, "explanation": "Inheritance of the MN blood antigen involves codominance. [cite: 65]" },
  { "id": 27, "question": "Which pattern of inheritance shows an intermediate phenotype other than the two parental phenotypes?", "options": ["Codominance", "Incomplete Dominance", "Multiple Alleles", "Dihybridism"], "correct": 1, "explanation": "Incomplete Dominance is where an intermediate phenotype other than the two parental phenotypes is observed. [cite: 67]" },
  { "id": 28, "question": "Which plant is used to demonstrate Incomplete Dominance where red and white parents produce pink offspring?", "options": ["Pisum sativum", "Mirabilis jalapa", "Zea mays", "Oryza sativa"], "correct": 1, "explanation": "Mirabilis jalapa ('alas cuatro') is the example for incomplete dominance. [cite: 68]" },
  { "id": 29, "question": "The ABO blood types in humans are an example of which genetic phenomenon?", "options": ["Lethal Genes", "Sex-linked traits", "Multiple Alleles", "Polygenic Inheritance"], "correct": 2, "explanation": "Inheritance of ABO blood types in humans is an example of Multiple Alleles. [cite: 69]" },
  { "id": 30, "question": "What are the antigens on the surface of red blood cells used in blood typing called?", "options": ["Agglutinins", "Agglutinogens", "Antibodies", "Glycoproteins"], "correct": 1, "explanation": "A and B antigens are also called agglutinogens. [cite: 70]" },
  { "id": 31, "question": "Which inherited protein on the surface of red blood cells determines if a person's blood type is 'positive' or 'negative'?", "options": ["MN factor", "Rh factor", "ABO factor", "Clotting factor"], "correct": 1, "explanation": "Rhesus (Rh) factor is an inherited protein; if present, you are Rh positive. [cite: 72, 73]" },
  { "id": 32, "question": "What is the condition where a certain combination of alleles results in the death of the carrier?", "options": ["Pleiotropy", "Polygenic inheritance", "Lethal Genes", "Non-Mendelian inheritance"], "correct": 2, "explanation": "Lethal Genes refer to a condition where a certain combination of alleles will result in the death of the carrier. [cite: 76]" },
  { "id": 33, "question": "In green plants, the absence of chlorophyll resulting in albinism is an example of:", "options": ["Incomplete dominance", "Lethal Genes", "Codominance", "Multiple Alleles"], "correct": 1, "explanation": "Absence of chlorophyll results in albinism, which is lethal to the carrier. [cite: 78]" },
  { "id": 34, "question": "Which type of inheritance involves traits controlled by two or more genes, such as skin color and height?", "options": ["Multiple Alleles", "Sex-linked Inheritance", "Polygenic Inheritance", "Pleiotropy"], "correct": 2, "explanation": "Polygenic inheritance involves traits controlled by two or more genes. [cite: 80]" },
  { "id": 35, "question": "What is the inheritance of genes located in the sex chromosomes called?", "options": ["Autosomal inheritance", "Sex-influenced inheritance", "Sex-linked inheritance", "Polygenic inheritance"], "correct": 2, "explanation": "Sex-linked inheritance refers to the inheritance of genes located in the sex chromosomes. [cite: 83]" },
  { "id": 36, "question": "Color blindness is characterized as what type of genetic trait?", "options": ["Dominant X-linked", "Recessive X-linked", "Y-linked", "Autosomal dominant"], "correct": 1, "explanation": "Color blindness is inherited as a recessive X-linked gene. [cite: 89]" },
  { "id": 37, "question": "Which test is used to determine color blindness in a person?", "options": ["Punnett Square", "Ishihara Test", "Karyotyping", "Pedigree analysis"], "correct": 1, "explanation": "The Ishihara Test is a common color perception test to determine color blindness. [cite: 90]" },
  { "id": 38, "question": "Which genetic disorder is caused by a missing or defective clotting protein called factor VIII?", "options": ["Sickle cell anemia", "Hemophilia A", "Albinism", "Down Syndrome"], "correct": 1, "explanation": "Hemophilia A is a genetic disorder caused by missing or defective factor VIII, a clotting protein. [cite: 96]" },
  { "id": 39, "question": "What term describes autosomal traits whose expression of dominance is affected by the sex of the individual, such as male-pattern baldness?", "options": ["Sex-linked inheritance", "Sex-influenced inheritance", "Pleiotropy", "Lethal genes"], "correct": 1, "explanation": "Sex-influenced inheritance refers to autosomal traits whose expression is affected by the sex of the individual. [cite: 105, 107]" },
  { "id": 40, "question": "What is the condition where one single gene causes several effects in various organs of the body?", "options": ["Polygenic inheritance", "Pleiotropy", "Codominance", "Multiple Alleles"], "correct": 1, "explanation": "Pleiotropy is a condition when one gene causes several effects (multiple traits) in various organs. [cite: 108, 110]" },
  { "id": 41, "question": "A genetic family tree that shows members affected by a certain trait for several generations is a:", "options": ["Karyotype", "Pedigree chart", "Punnett Square", "Gene map"], "correct": 1, "explanation": "A pedigree chart is a genetic family tree that shows members of a family affected by a certain trait. [cite: 113]" },
  { "id": 42, "question": "What is a picture of all chromosomes in a cell used to identify changes like missing or extra chromosomes?", "options": ["Genotype", "Karyotype", "Phenotype", "Genome"], "correct": 1, "explanation": "A karyotype is a picture of all chromosomes in a cell. [cite: 117]" },
  { "id": 43, "question": "Which chromosomal condition, involving a deletion, alters development in females and often leads to infertility?", "options": ["Down Syndrome", "Turner Syndrome", "Hemophilia", "Color blindness"], "correct": 1, "explanation": "Turner Syndrome is a chromosomal condition that alters development in females, often characterized by a deletion. [cite: 121]" },
  { "id": 44, "question": "What disorder is caused by the presence of all or part of a third copy of chromosome 21?", "options": ["Turner Syndrome", "Hemophilia", "Down Syndrome", "Albinism"], "correct": 2, "explanation": "Down Syndrome, also known as trisomy 21, is caused by a third copy of chromosome 21. [cite: 123]" },
  { "id": 45, "question": "Approximately how many nitrogenous bases make up human DNA?", "options": ["3 million", "30 million", "3 billion", "300 billion"], "correct": 2, "explanation": "Human DNA consists of 3 billion bases. [cite: 124]" },
  { "id": 46, "question": "What is the building block of DNA, consisting of a base, a sugar, and a phosphate group?", "options": ["Nucleosome", "Histone", "Nucleotide", "Amino acid"], "correct": 2, "explanation": "A nucleotide is the building block of DNA. [cite: 127]" },
  { "id": 47, "question": "Which specific sugar is found in the DNA backbone?", "options": ["Ribose", "Deoxyribose", "Glucose", "Fructose"], "correct": 1, "explanation": "DNA contains a five-carbon sugar called deoxyribose. [cite: 127]" },
  { "id": 48, "question": "In DNA, which base always pairs with Cytosine (C)?", "options": ["Adenine (A)", "Thymine (T)", "Guanine (G)", "Uracil (U)"], "correct": 2, "explanation": "Complementary base pairing in DNA is C to G. [cite: 127]" },
  { "id": 49, "question": "Who developed the double helical structure model of DNA in 1953?", "options": ["Gregor Mendel", "Francis Crick and James Watson", "Shinobu Ishihara", "Charles Darwin"], "correct": 1, "explanation": "In 1953, Watson and Crick developed the double helical structure of DNA. [cite: 128]" },
  { "id": 50, "question": "The 5' and 3' in a DNA strand refer to the:", "options": ["Number of bases", "Carbon numbers in the sugar backbone", "Number of phosphate groups", "Temperature for replication"], "correct": 1, "explanation": "The 5' and 3' indicate the carbon numbers in the DNA's sugar backbone. [cite: 129]" },
  { "id": 51, "question": "Which enzyme is responsible for breaking the hydrogen bonds to separate DNA strands during replication?", "options": ["Polymerase", "Ligase", "Helicase", "Restriction enzyme"], "correct": 2, "explanation": "Enzymes called helicase break the hydrogen bond between the DNA strands. [cite: 131]" },
  { "id": 52, "question": "The result of DNA replication is two molecules, each containing:", "options": ["Two new strands", "Two original strands", "One original and one new strand", "RNA instead of DNA"], "correct": 2, "explanation": "Each DNA molecule resulting from replication has one original strand and one new strand. [cite: 136]" },
  { "id": 53, "question": "Which nitrogenous base is unique to RNA and replaces Thymine?", "options": ["Adenine", "Guanine", "Cytosine", "Uracil"], "correct": 3, "explanation": "In RNA, the bases are A, U, G, C. [cite: 137]" },
  { "id": 54, "question": "Which type of RNA transcribes and copies genetic information from the DNA inside the nucleus?", "options": ["rRNA", "tRNA", "mRNA", "snRNA"], "correct": 2, "explanation": "Messenger RNA (mRNA) transcribes and copies genetic information from the DNA strand inside the nucleus. [cite: 139]" },
  { "id": 55, "question": "What is the three-nucleotide sequence that codes for a specific amino acid?", "options": ["Anticodon", "Gene", "Codon", "Nucleotide"], "correct": 2, "explanation": "A codon is a three-nucleotide sequence that codes for an amino acid. [cite: 142]" },
  { "id": 56, "question": "Which codon signals the start of translation and codes for methionine?", "options": ["Stop Codon", "Start Codon", "Anticodon", "Triplet Codon"], "correct": 1, "explanation": "The Start Codon signals the start of translation (methionine). [cite: 143]" },
  { "id": 57, "question": "Who defined the 'Central Dogma' of molecular biology?", "options": ["Gregor Mendel", "Francis Crick", "James Watson", "Shinobu Ishihara"], "correct": 1, "explanation": "Francis Crick defined the Central Dogma of molecular biology. [cite: 147]" },
  { "id": 58, "question": "According to the Central Dogma, information flows in which direction?", "options": ["Protein to RNA to DNA", "RNA to DNA to Protein", "DNA to RNA to Protein", "DNA to Protein to RNA"], "correct": 2, "explanation": "The Central Dogma states information flows from DNA to RNA to proteins. [cite: 147]" },
  { "id": 59, "question": "Which process converts a DNA message into an intermediate molecule called RNA?", "options": ["Replication", "Transcription", "Translation", "Transformation"], "correct": 1, "explanation": "Transcription converts a DNA message into an intermediate molecule, called RNA. [cite: 149]" },
  { "id": 60, "question": "Which process interprets an RNA message into a string of amino acids (polypeptide)?", "options": ["Replication", "Transcription", "Translation", "Cloning"], "correct": 2, "explanation": "Translation interprets an RNA message into a string of amino acids. [cite: 150]" }
];
